...
const Content = () => {
  ...
  {/* sidebar */}
      <div className={`${menuExpand ? "block w-48 h-screen" : "hidden md:flex flex-col w-64 bg-gray-800"}`}>
  ...
  <div className="flex flex-col flex-1 overflow-y-auto">
    <div className="flex items-center justify-between h-16 bg-white border-b border-gray-200">
      <div className="flex items-center px-4">
        <button onClick={()=>setMenuExpand(!menuExpand)} className="text-gray-500 focus:outline-none focus:text-gray-700">
